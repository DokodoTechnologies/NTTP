...
export default function Home() {
  const contentSections = [
    {
      ...
      leftContent: {
        title1: "NTTP Forum",
        text1:
          "The national dialogue process takes place through the NTTP Forum and the inter-party dialogue forums convened by senior facilitators of the NTTP-I",
  ...
  const handlePrevious = () => {
    setCurrentPage((prev) =>
      prev > 0 ? prev - 1 : contentSections.length - 1,
    );
  };
              ...
              <div className='col-xl-8 col-lg-7'>
                <div className='project-details__left'>
                  ...
                  <p className='project-details__text-1'>
                    {currentContent.leftContent.text1}
                  </p>
                  <p className='project-details__text-2'>
                    {currentContent.leftContent.text2}
                  </p>
                  ...
                  <p className='project-details__text-3'>
                    {currentContent.leftContent.text3}
                  </p>
                </div>
              </div>
