...
//                                 </div>
//                                 <div className="text">
//                                     <p><Link href="mailto:example@gamil.com">mantte@gamil.com</Link>
//                                     </p>
//                                 </div>
//                             </li>
//                             <li>
    ...
    <Link href="/">
        ...
        />
                            ...
                            <div className="main-menu__right">
                                ...
                                <div className="main-menu__btn-box">
                                    <Link href="/" className="main-menu__btn thm-btn">Contact Now<span><i
                                                className="icon-arrow-right"></i></span></Link>
                                </div>
                            </div>
                        </div>
        ...
        />
                                ...
                                <div className="main-menu__right">
                                    ...
                                    <div className="main-menu__btn-box">
                                        <Link href="donation-details" className="main-menu__btn thm-btn">Contact Now<span><i
                                                    className="icon-arrow-right"></i></span></Link>
                                    </div>
                                </div>
                            </div>
