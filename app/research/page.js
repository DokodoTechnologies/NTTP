...
export default function TestimonialsPage() {
  ...
  return (
    <>
      <Layout headerStyle={1} footerStyle={2} breadcrumbTitle='Research'>
        {" "}
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-12'>
                {" "}
                {/* Changed from col-xl-8 col-lg-7 to col-12 for full width */}
                <div className='project-details__left'>
                  <h3 className='project-details__title-1 main-heading'>
                    {researchContent.leftContent.title1}
                  </h3>
                  <p className='project-details__text-1'>
                    {researchContent.leftContent.text1}
                  </p>
                  <p className='project-details__text-2'>
                    {researchContent.leftContent.text2}
                  </p>
